...
metadata_files = '/media/sf_Z_DRIVE/Working/OAG/working/presentation6' #input("directory with correct metadata file: ")
...
seriousFilepath = '/media/sf_F_DRIVE/Archives/Electronic_records/Texas_Digital_Archive/working_materials/newAPI/attyGeneral/ag_abbott/correcto' #input("XIP files directory without trailing /:")
